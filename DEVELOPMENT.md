...
```bash
git remote add encore encore://ai-holiday-planner-g962
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/ai-holiday-planner-g962/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/ai-holiday-planner-g962/settings/integrations/github)
